...
public let alertDefaultHeight: CGFloat = 350.0

/// alert controller button spacing
public let alertDefaultActionItemSpace: CGFloat = 5.0

/// alert controller button height
public let alertDefaultActionItemHeight: CGFloat = 50.0
...
public enum AlertStyle: AlertStyleType {
