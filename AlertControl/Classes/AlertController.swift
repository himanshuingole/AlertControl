...
open class AlertController: UIViewController {
    ...
    private func configureMessageView() {
        ...
        let buttonsHeight = buttonsStackView.systemLayoutSizeFitting(UILayoutFittingCompressedSize).height  + viewModel.alertStyle.topSpace + viewModel.alertStyle.bottomSpace
    ...
    @objc func buttonTapped(button: UIButton) {
        dismiss(animated: true,
                completion: viewModel.actions[button.tag].tapAction)
